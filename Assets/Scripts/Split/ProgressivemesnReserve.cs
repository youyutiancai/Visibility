...
//            string log = $"removed vertex: {vertexToRemove}.. submesh: {submesh}.. triangles it has: {string.Join(',', trianglesVert[vertexToRemove])}.. " +
...
//                //int largestVertexInd = 0;
//                //int triIndex = 0;
//                //for (int i = 0; i < currentTriangles[submesh].Count; i++)
//                //{
//                //    if (currentTriangles[submesh][i] > largestVertexInd)
//                //    {
//                //        largestVertexInd = currentTriangles[submesh][i];
//                //        triIndex = i / 3;
//                //    }
//                //}
//                List<int> newTriangles = new List<int>();
